...
VALUES (1, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (2, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (3, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (4, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (5, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (11, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (12, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (13, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (14, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (15, "2016-12-10 14:00:00", "2016-12-10 14:00:00"),
	   (21, "2016-12-10 14:00:00", "2016-12-10 14:00:00");
...
DELIMITER $$
USE `reservation_system`$$
CREATE PROCEDURE `delete_closed_computers` (IN rumid INT)
BEGIN
	DELETE FROM `reservation_system`.`closed_pcs`
	WHERE `computerid` IN (SELECT `computerid` FROM `reservation_system`.`computers` WHERE `roomid` = rumid);
END$$
